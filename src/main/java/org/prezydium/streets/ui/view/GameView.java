...
public class GameView extends VerticalLayout implements View {
    ...
    private Button makeGuessButton = new Button("Zgadnij!", this::clickButton);
    ...
    public void enter(ViewChangeListener.ViewChangeEvent event) {
        this.addComponents(header, chancesLabel, guessedWordLabel, textFieldGuess, makeGuessButton);
    }

    private void clickButton(Button.ClickEvent clickEvent ){
